        ...
        <svg :style="{border: color}" style="{border: solid 2px}" height="800px" width="800px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
            ...
            <g>
                <path  d="M244.63,35.621c-21.771-18.635-47.382-29.855-73.767-33.902C121.871-5.797,70.223,11.421,35.622,51.847
                    ...
                    c17.789-3.467,34.585-12.651,47.394-27.342l36.121,31.409C233.154,252.087,214.257,265.047,193.203,272.635z" :style="{fill: color}" />
                <circle cx="93.372" cy="53.498" r="8" :style="{fill: color}"/>
                <circle cx="38.758" cy="148.382" r="8" :style="{fill: color}"/>
                <circle cx="93.623" cy="243.123" r="8" :style="{fill: color}"/>
                <circle cx="203.105" cy="242.977" r="8.001" :style="{fill: color}"/>
                <circle cx="257.717" cy="148.091" r="8" :style="{fill: color}"/>
                <circle cx="202.853" cy="53.351" r="8" :style="{fill: color}"/>
            </g>
        </svg>
    </div>
</template>
